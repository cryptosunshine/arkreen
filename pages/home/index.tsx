...
export default function Home() {
  ...
  const dividerStyle:React.CSSProperties = {borderColor:'#CBCBD2',borderWidth:'1.5px',margin:'16px 0px'}
  return (
              ...
              <div style={itemContextStyle}>
                <div style={itemEleStyle}>
                  <div style={itemEleRowStyle}>
                    <div style={valueMainStyle}>{loading?<Skeleton.Input active block />:(dashboardStatistics?Number(dashboardStatistics.green_total).toLocaleString():0)}</div>
                    <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:(dashboardStatistics?(<span style={{color:dashboardStatistics.green_increment<0?'#0072DB':'#00913A'}}>{dashboardStatistics.green_increment<0?<DecLineIcon />:<RiseLineIcon />}<span>{' '+dashboardStatistics.green_increment}</span></span>):0)}</div>
                  </div>
                </div>
                <div>
                ...
                <div style={itemEleStyle}>
                  ...
                  <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:<></>}</div>
                </div>
            ...
            <div style={itemMainStyle}>
              ...
              <div style={itemContextStyle}>
                <div style={itemEleStyle}>
                  ...
                  <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:(dashboardStatistics?(<span style={{color:dashboardStatistics.green_power_increment<0?'#0072DB':'#00913A'}}>{dashboardStatistics.green_power_increment<0?<DecLineIcon />:<RiseLineIcon />}<span>{' '+Number(dashboardStatistics.green_power_increment/1000/1000).toFixed(3)}</span></span>):0)}</div>
                </div>
                <div>
                  <Divider dashed style={dividerStyle} />
                </div>
                <div style={itemEleStyle}>
                  ...
                  <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:(dashboardStatistics?(<span style={{color:dashboardStatistics.power_increment<0?'#0072DB':'#00913A'}}>{dashboardStatistics.power_increment<0?<DecLineIcon />:<RiseLineIcon />}<span>{' '+Number(dashboardStatistics.power_increment/1000/1000/1000).toFixed(3)}</span></span>):0)}</div>
                </div>
              </div>
            </div>
          </div>
           ...
           <div style={itemMainStyle}>
             ...
             <div style={itemContextStyle}>
               <div style={itemEleStyle}>
                 <div style={itemEleRowStyle}>
                   {loading?<Skeleton.Input active block />:<>
                     <div style={valueMainStyle}>{loading?<Skeleton.Input active block />:(dashboardStatistics?(<span>{Number(dashboardStatistics.circulating_supply_consumption).toFixed(5)}</span>):0)}</div>
                     <div style={valueMainUnitStyle}>%</div>
                   </>}
                 </div>
                 <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:(dashboardStatistics?(<span style={{color:dashboardStatistics.circulating_supply_consumption_increment<0?'#0072DB':'#00913A'}}>{dashboardStatistics.circulating_supply_consumption_increment<0?<DecLineIcon />:<RiseLineIcon />}<span>{' '+Number(dashboardStatistics.circulating_supply_consumption_increment).toFixed(5)}</span></span>):0)}</div>
               </div>
               <div>
                 <Divider dashed style={dividerStyle} />
               </div>
               <div style={itemEleStyle}>
                 ...
                 <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:(dashboardStatistics?(<span style={{color:dashboardStatistics.circulating_supply_increment<0?'#0072DB':'#00913A'}}>{dashboardStatistics.circulating_supply_increment<0?<DecLineIcon />:<RiseLineIcon />}<span>{' '+dashboardStatistics.circulating_supply_increment}</span></span>):0)}</div>
               </div>
             </div>
           </div>
         </div>
           ...
           <div style={itemMainStyle}>
             ...
             <div style={itemContextStyle}>
               <div style={itemEleStyle}>
                 ...
                 <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:<span style={{color:'#00913A'}}><RiseLineIcon /> 0.000</span>}</div>
               </div>
               <div>
                 <Divider dashed style={dividerStyle} />
               </div>
               <div style={itemEleStyle}>
                 ...
                 <div style={valueIncrementStyle}>{loading?<Skeleton.Input active block />:<span style={{color:'#0072DB'}}><DecLineIcon /> 100</span>}</div>
               </div>
             </div>
           </div>
         </div>
